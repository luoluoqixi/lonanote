...
pub trait LonanoteRustModuleSpec {
    ...
    fn emit(&self, signal_name: LonanoteRustModuleSignal) {
        ...
        match signal_name {
            ...
            LonanoteRustModuleSignal::OnRustLog(data) => {
                let signal = Box::new(LonanoteRustModuleSignal::OnRustLog(data));
                let signal_ptr = Box::into_raw(signal);
                unsafe {
                    manager.emit(self.id(), "onRustLog", signal_ptr);
                }
            }
        }
    }
