...
enum CustomScrollbarOrientation {
...
///
/// You must call [dispose] on this [CustomScrollbarPainter] when it's no longer used.
///
/// See also:
///
...
class CustomScrollbarPainter extends ChangeNotifier implements CustomPainter {
  ...
  CustomScrollbarPainter({
    ...
    CustomScrollbarOrientation? scrollbarOrientation,
  ...
  ///
  /// [CustomScrollbarOrientation.top] places the scrollbar on top of the screen.
  /// [CustomScrollbarOrientation.bottom] places the scrollbar on the bottom of the screen.
  /// [CustomScrollbarOrientation.left] places the scrollbar on the left of the screen.
  /// [CustomScrollbarOrientation.right] places the scrollbar on the right of the screen.
  ///
  /// [CustomScrollbarOrientation.top] and [CustomScrollbarOrientation.bottom] can only be
  /// used with a vertical scroll.
  /// [CustomScrollbarOrientation.left] and [CustomScrollbarOrientation.right] can only be
  /// used with a horizontal scroll.
  ///
  /// For a vertical scroll the orientation defaults to
  /// [CustomScrollbarOrientation.right] for [TextDirection.ltr] and
  /// [CustomScrollbarOrientation.left] for [TextDirection.rtl].
  /// For a horizontal scroll the orientation defaults to [CustomScrollbarOrientation.bottom].
  /// {@endtemplate}
  CustomScrollbarOrientation? get scrollbarOrientation => _scrollbarOrientation;
  CustomScrollbarOrientation? _scrollbarOrientation;
  set scrollbarOrientation(CustomScrollbarOrientation? value) {
  ...
  double get _leadingTrackMainAxisOffset => switch (_resolvedOrientation) {
        CustomScrollbarOrientation.left ||
        CustomScrollbarOrientation.right =>
          padding.top,
        CustomScrollbarOrientation.top ||
        CustomScrollbarOrientation.bottom =>
          padding.left,
      };
  ...
  CustomScrollbarOrientation get _resolvedOrientation {
    if (scrollbarOrientation == null) {
      ...
      return CustomScrollbarOrientation.bottom;
    }
    return scrollbarOrientation!;
  }

  void _debugAssertIsValidOrientation(CustomScrollbarOrientation orientation) {
    assert(
      () {
        bool isVerticalOrientation(CustomScrollbarOrientation orientation) =>
            orientation == CustomScrollbarOrientation.left ||
            orientation == CustomScrollbarOrientation.right;
  ...
  void _paintScrollbar(Canvas canvas, Size size) {
    ...
    switch (_resolvedOrientation) {
      case CustomScrollbarOrientation.left:
      ...
      case CustomScrollbarOrientation.right:
        thumbSize = Size(thickness, _thumbExtent);
        trackSize = Size(thickness + 2 * crossAxisMargin, _trackExtent);
      ...
      case CustomScrollbarOrientation.top:
      ...
      case CustomScrollbarOrientation.bottom:
        thumbSize = Size(_thumbExtent, thickness);
        trackSize = Size(_trackExtent, thickness + 2 * crossAxisMargin);
        x = _thumbOffset;
...
/// [CustomScrollView], wrap the scroll view widget in a [CustomRawScrollbar] widget.
///
...
///
/// If the child [ScrollView] is infinitely long, the [CustomRawScrollbar] will not be
...
///
/// {@tool dartpad}
/// This sample shows a [CustomRawScrollbar] that executes a fade animation as
...
/// `controller` for both the [CustomRawScrollbar] and the [GridView].
...
class CustomRawScrollbar extends StatefulWidget {
  ...
  /// See also:
  ///
  ///   * [CustomRawScrollbarState.showScrollbar], an overridable getter which uses
  ...
  /// See also:
  ///
  ///   * [CustomRawScrollbarState.enableGestures], an overridable getter which uses
  ///     this value to override the default behavior.
  /// {@endtemplate}
  ...
  @override
  CustomRawScrollbarState<CustomRawScrollbar> createState() =>
      CustomRawScrollbarState<CustomRawScrollbar>();
}

/// The state for a [CustomRawScrollbar] widget, also shared by the [Scrollbar] and
...
/// scrollbar track.
class CustomRawScrollbarState<T extends CustomRawScrollbar> extends State<T>
  ...
  @protected
  late final CustomScrollbarPainter scrollbarPainter;
  ...
  /// theme.
  ///
  /// Defaults to false when [CustomRawScrollbar.thumbVisibility] is null.
  @protected
  ...
  /// theme.
  ///
  /// Defaults to true when [CustomRawScrollbar.interactive] is null.
  ///
  /// See also:
  ///
  ///   * [CustomRawScrollbar.interactive], which overrides the default behavior.
  @protected
  ...
  void initState() {
    ...
    scrollbarPainter = CustomScrollbarPainter(
  ...
  Map<Type, GestureRecognizerFactory> get _gestures {
    ...
    gestures[_TrackTapGestureRecognizer] =
      ...
      () => _TrackTapGestureRecognizer(
          debugOwner: this, customPaintKey: _scrollbarPainterKey),
  ...
  /// [CustomRawScrollbar].
  ///
  /// Excludes the [CustomRawScrollbar] thumb.
  @protected
...
bool _isThumbEvent(GlobalKey customPaintKey, PointerEvent event) {
  ...
  final CustomScrollbarPainter painter =
      customPaint.foregroundPainter! as CustomScrollbarPainter;
...
class _TrackTapGestureRecognizer extends TapGestureRecognizer {
  _TrackTapGestureRecognizer(
      {required super.debugOwner, required GlobalKey customPaintKey})
