...
export const ToggleTip = React.forwardRef<HTMLDivElement, ToggleTipProps>((props, ref) => {
...
export const InfoTip = React.forwardRef<HTMLDivElement, Partial<ToggleTipProps>>((props, ref) => {
