...
// reference code:
// https://github.com/toly1994328/FlutterUnit/blob/master/modules/basic_system/components/lib/flutter_ui/diy_flexible_space_bar.dart
        ...
        if (widget.title != null) {
          ...
          if (opacity > 0.0) {
            ...
            titleStyle = titleStyle.copyWith(
              color: titleStyle.color!.withAlpha((255.0 * opacity).round()),
            );
