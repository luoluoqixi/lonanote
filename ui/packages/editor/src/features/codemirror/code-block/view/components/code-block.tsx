...
import { Fragment, type Ref, computed, defineComponent, h, onMounted, ref } from 'vue';
        ...
        <>
          <div class="tools">
            ...
            {preview.value ? (
              ...
              >
                <Icon icon={props.config.previewToggleButton(previewOnlyMode.value)} />
              </button>
            ) : null}
          </div>
          <div
            ref={codemirrorHostRef}
            class={clsx('codemirror-host', preview.value && previewOnlyMode.value && 'hidden')}
          />
          <PreviewPanel
            text={props.text}
            language={props.language}
