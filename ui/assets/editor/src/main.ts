...
function createStandaloneInitializeRequest(): EditorBridgeRequest {
  ...
  const colors = darkMode
    ? {
        ...
        checkboxBorder: "#b2a5e6",
        checkboxChecked: "#b2a5e6",
    ...
    : {
        ...
        checkboxBorder: "#894eef",
        checkboxChecked: "#894eef",
...
function applyRuntimeStyles(runtime: EditorRuntimeUpdatePayload): void {
  ...
  const colorVariables = {
    ...
    "--lonanote-editor-inline-code-background": colors.inlineCodeBackground,
    "--lonanote-editor-inline-code-text": colors.inlineCodeText,
    "--lonanote-editor-formatting": colors.formatting,
    "--lonanote-editor-list-marker": colors.listMarker,
